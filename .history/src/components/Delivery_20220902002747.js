                ...
                <div className='col-span-1'>
                    <div className='content'>
                        ...
                        <div className='flex mt-10'>
                            ...
                            <div className='ml-4'>
                                <a href='' className='font-semibold hover:text-black  px-[15px] py-[10px] rounded-[30px]    bg-orange-300 absolute text-[20px] text-white'> 
                                <FontAwesomeIcon className='mr-[12px]' icon={faShoppingCart}/>Order Now</a>
                            </div>
                        </div>
