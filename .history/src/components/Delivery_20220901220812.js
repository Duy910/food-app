            ...
            <div className='max-w-[1200px] my-0 mx-auto h-full grid grid-cols-2 '>
                ...
                <div className='col-span-1'>
                    <div className='content'>
                        <div>
                            <h1 className='font-delius text-primary text-[30px]'>FREE DELIVERY</h1>
                        </div>
                        <div>
                            <h1 className='font-rubik font-semibold text-[50px]'>Delivered On Right Time And Place</h1>
                        </div>
                        <div>
                        ...
                        <div>
                            <div>
                                <div>
                                    <img src={phone} className='max-w-full h-auto'/>
                                </div>
                                <div>   
