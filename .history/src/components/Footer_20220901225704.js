        ...
        <div>
            <div className="max-w-[1200px] my-20 mx-auto grid grid-cols-4 text-center">
                ...
                <div className="col-span-2">
                    ...
                    <div>
                            <a href='' className='p-2 '><FontAwesomeIcon className='text-primary text-[40px]' icon={faFacebook}/></a>
                            <a href='' className='p-2 '><FontAwesomeIcon className='text-primary text-[40px]' icon={faInstagram}/></a>
                            <a href='' className='p-2 '><FontAwesomeIcon className='text-primary text-[40px]' icon={faTwitter}/></a>
                            <a href='' className='p-2 '><FontAwesomeIcon className='text-primary text-[40px]' icon={faYoutube}/></a>
                    </div>
                </div>
                <div className="col-span-1">
                    <div>
