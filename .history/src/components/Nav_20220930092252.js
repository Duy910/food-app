                    ...
                    <div>
                        <ul className='flex h-14 items-center hover:cursor-pointer  '>
                            ...
                            <li className='relative text-xl text-white ml-24 hover:text-yellow-200 '>
                                ...
                                <div className=''>
                                       <span className='absolute text-[14px] leading-5 px-2 text-center font-bold text-primary rounded-full border-[1px] top-[-10px] left-[10px] border-[#1e293b] border-solid bg-white' >0</span>
                                </div>
