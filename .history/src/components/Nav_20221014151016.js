    ...
    return (
        ...
        <nav>
            <div className=" h-14 bg-slate-800 fixed w-full z-50 font-delius">
                ...
                {/* {mobile}------------------------------------------------------------------- */}
                <div className='max-w-[1200px] my-0 mx-auto  phone:justify-around tablet:hidden hidden phone:flex '>
                    ...
                    <ul className='h-14  hover:cursor-pointer relative items-center '>
                        ...
                        <li className='relative text-xl text-white  hover:text-yellow-200 '>
                            <div href='/food-app' className='iconProduct' >
