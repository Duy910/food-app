...
let items = []
function CartItems({ cartitem, setFlag, flag  }) {
    ...
    return (
        ...
        <li key={cartitem?.id} className=' flex bg-[#fff8ef] justify-between relative '>
            <div className='flex py-2 items-center justify-between'>
                ...
                <div className='ml-2'>
                    ...
                    <h1 className='text-black font-bold font-delius italic text-[18px] my-2'><FontAwesomeIcon icon={faEuroSign} />{cartitem?.price * cartitem.qty}</h1>
            ...
            <div className='flex items-center'>
                <div className=" flex bg-primary   rounded-[20px] text-[16px] ">
                    ...
                    <p className="py-1 px-2 text-white">{qty}</p>
                    <button
