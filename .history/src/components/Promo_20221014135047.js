    ...
    return ( 
        <div className=" h-[500px] relative">
            ...
            <div className="max-w-[1200px] h-full my-0 mx-auto grid grid-cols-2 ">
                ...
                <div className=" tablet:col-span-1 phone:col-span-1 h-[50%] mr-5 mt-[125px]  promo1 bg-cover bg-center bg-no-repeat rounded-[20px] relative hover:shadow-2xl">
                    <div className='text-white text-[30px] promo-font absolute top-[5%] right-[16%] font-bold'>
                        <h1>DOUBLE</h1>
                        <h1>CHEESE PIZZA</h1>
                    </div>
                    <div className=''>
                    <Link to='/food-app' className='tablet:block phone:hidden font-semibold hover:text-black top-[64%] right-[20%] px-[15px] py-[10px] rounded-[30px]  bg-orange-300 absolute text-[20px] text-white'> 
                ...
                <div className=" col-span-1 h-[50%] ml-5 mt-[125px] promo2 bg-cover bg-center bg-no-repeat  rounded-[20px] relative hover:shadow-2xl">
                    <div className='text-white text-[30px] promo-font absolute top-[5%] right-[20%] font-bold'>
                            <h1>MEXICAN</h1>
                            <h1>GREEN</h1>
                            <h1>WAVE</h1>
                        </div>
