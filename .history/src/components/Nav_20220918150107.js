...
import { faBagShopping, faUser, faImage , faBasketShopping} from '@fortawesome/free-solid-svg-icons';
                    ...
                    <div className='max-w-[1200px] my-0 mx-auto flex items-center h-14 justify-between '>
                        ...
                        <div>
                            <ul className='flex h-14 items-center hover:cursor-pointer hover:text-yellow-200'>
                                ...
                                <li><FontAwesomeIcon icon={faUser} className='text-white ml-20 h-5'/></li>
                                <li className='text-2xl text-white ml-24 hover:text-yellow-200'><Link to='/cart'><FontAwesomeIcon icon={faBasketShopping} /></Link></li>
