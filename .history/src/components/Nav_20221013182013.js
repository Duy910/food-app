    ...
    return (
        ...
        <nav>
            <div className=" h-14 bg-slate-800 fixed w-full z-50 font-delius">
                    ...
                    <div className=''>
                        ...
                        <ul className='flex h-14 items-center hover:cursor-pointer  '>
                            ...
                            <li className='active flex '>
                                <ul className='flex'>
                                    <li className='text-white ml-6 hover:text-yellow-200 '><Link to='/signin'>Sign in</Link></li>
                                    <li className='text-white ml-2 hover:text-yellow-200 mr-20 '><Link to='/signup'>Sign up</Link></li>
                                </ul>
                            </li>
                            ...
                            <li className='relative text-xl text-white ml-24 hover:text-yellow-200 '>
                                <div href='/food-app' className='iconProduct' >
                                    ...
                                    <div className='w-[400px]  z-20  absolute top-[149%] right-[-705%] listProduct   bg-white   '>
                ...
                {/* {tablet} */}
                <div className='max-w-[1200px] my-0 mx-auto md:flex justify-between hidden xl:hidden'>
