                        ...
                        <ul className='flex h-14 items-center hover:cursor-pointer '>
                            ...
                            <li className='active flex '>
                                <ul className='flex'>
                                    ...
                                    <li className='text-white ml-8 hover:text-yellow-200 ml-20 '><Link to='/signup'>Sign up</Link></li>
                                </ul>
                            </li>
                            ...
                            />
                            <ul className='absolute bg-white top-[48px] text-center w-[140px]  left-[34px] py-6 rounded-[10px] shadow-xl  font-delius optionUser none'>
                                <li className='pb-2 hover:text-primary'>New Product <FontAwesomeIcon icon={faPlus} className='ml-1'/> </li>
                                <li className='pb-2 hover:text-primary  '>Logout <FontAwesomeIcon icon={faRightFromBracket} className='ml-1' /></li>
                            </ul>
                            </li>
