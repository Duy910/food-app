...
function Delivery() {
    return ( 
        <div className="h-[700px] bg-[#fff8ef] relative">
            ...
            <img src={shape13} className='absolute phone:hidden des:block top-[40%] right-[46%]' />
            ...
            <div className='max-w-[1200px] my-0 mx-auto h-full grid grid-cols-2 '>
                ...
                <div className='phone:col-span-2 tablet:col-span-1'>
                    <div className='content '>
                        <div >
                            <h1 className='font-delius text-primary tablet:text-[30px] phone:text-[20px] mt-20 '>FREE DELIVERY</h1>
                        </div>
                        <div>
                        ...
                        <div className='lg:flex md:block phone:block mt-10'>
                            <div className='flex '>
                                <div>
