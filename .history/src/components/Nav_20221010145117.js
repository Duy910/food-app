...
import { faBagShopping, faUser, faImage, faBasketShopping, faUserCircle, faPlus, faRightFromBracket, faEuroSign } from '@fortawesome/free-solid-svg-icons';
                            ...
                            <li className='relative text-xl text-white ml-24 hover:text-yellow-200 '>
                                <Link to='/cart ' className='iconProduct' >
                                    ...
                                    <div className='w-[400px]  z-20  absolute top-[42px] right-[-160px] listProduct   bg-white '>
                                        ...
                                        <ul>
                                            <li>
                                                <div className='flex bg-[#fff8ef] py-2 items-center'>
                                                    <div className='bg-[#fef0de] rounded-[4px]'>
                                                        <img className='w-[100px] h-[100px] ' src={pizza}/>
                                                    </div>
                                                    <div >
                                                        <h1 className='text-primary font-delius italic text-[18px]'>Chocolate pizza rule</h1>
                                                        <h1 className='text-black font-bold font-delius italic text-[18px]'><FontAwesomeIcon icon={faEuroSign}/>23.3</h1>
