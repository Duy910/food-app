                                    ...
                                    <div className='w-[400px]  z-20  absolute top-[42px] right-[-160px] listProduct hidden bg-white   '>
                                        {cartItems.length > 0 ? (<div>
                                            ...
                                            <div className=' bg-[#fff8ef]  h-[100px] mt-[24%] rounded-t-[20px] flex items-center justify-around'>
                                                ...
                                                <div>
                                                    {user ? (<Link to='/cart' className='text-black text-[18px] font-bold items-center italic bg-primary p-2 rounded-[10px] listProductCheckOut'
                                                    >Check out</Link>) : (<span className='text-black text-[18px] font-bold items-center italic bg-primary p-2 rounded-[10px] listProductCheckOut'>Login to check out</span>)}
                                                </div>
                                            </div>
