                ...
                <div className='max-w-[1200px] my-0 mx-auto flex items-center h-14 justify-between '>
                    ...
                    <div>
                        <ul className='flex h-14 items-center hover:cursor-pointer '>
                            ...
                            <li className='relative text-xl text-white ml-24 hover:text-yellow-200 iconProduct'>
                            ...
                            <div className='w-[400px] min-h-[400px] bg-white absolute top-[56px] right-0 listProduct hover:block hidden'>
                                <ul>
