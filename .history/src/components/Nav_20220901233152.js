                    ...
                    <ul className='flex h-14 items-center hover:cursor-pointer ' >
                        ...
                        <li className='relative'><a href='' className='mr-6 text-white hover:text-yellow-200' >MENU</a>
                            <ul className='absolute bg-white py-6 rounded-[10px] '>
                                <li className='block relative'><a className='pl-4 pr-20 py-1 reletive '>Home</a></li>
                                <li className='block '><a className='pl-4 pr-20 py-1 reletive '>Sign in</a></li>
                                <li className=''><a>Sign up</a></li>
                                <li className=''><a>Cart</a></li>
                            </ul>
                        </li>
