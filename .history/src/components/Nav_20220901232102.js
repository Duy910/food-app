            ...
            <div>
                    <ul className='flex h-14 items-center hover:cursor-pointer ' >
                        ...
                        <li className='relative'><a href='' className='mr-6 text-white hover:text-yellow-200' >MENU</a>
                            <ul className='absolute bg-white p-6 rounded-[10px] block'>
                                <li className='px-6 py-2'><a className='w-full'>Home</a></li>
                                <li className='px-6 py-2'><a className='w-full'>Sign in</a></li>
                                <li className='px-6 py-2'><a>Sign up</a></li>
                                <li className='px-6 py-2'><a>Cart</a></li>
                            </ul>
                        </li>
