    ...
    return (
        ...
        <nav>
            <div className=" h-14 bg-slate-800 fixed w-full z-50 font-delius">
                ...
                {/* {tablet} */}
                <div className='max-w-[1200px] my-0 mx-auto md:flex hidden lg:hidden'>
                    <ul className='h-14  hover:cursor-pointer relative items-center justify-around flex'>
                        <li>
                            <Link to='/food-app'> <img src={logo} className="h-9 mr-10 " /></Link>
                        </li>
                        <li ><Link to='/food-app'
                        ...
                        <li ><Link to='/cart '
                            ...
                            className='mr-6 text-white hover:text-yellow-200' >CART</Link></li>
                        <li className='relative imageUser flex justify-end   '><img
                            src={user && user ? user.photoURL : Avatar}
                            className='w-8  rounded-full  '
                            onClick={login}
