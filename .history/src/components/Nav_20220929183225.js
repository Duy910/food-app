...
import { faBagShopping, faUser, faImage, faBasketShopping, faUserCircle, faPlus} from '@fortawesome/free-solid-svg-icons';
                ...
                <div className='max-w-[1200px] my-0 mx-auto flex items-center h-14 justify-between '>
                    ...
                    <div>
                        <ul className='flex h-14 items-center hover:cursor-pointer '>
                            ...
                            />
                            <ul className='absolute bg-white top-[48px] text-center w-[120px] left-[42px] py-6 rounded-[10px]   '>
                                <li className='pb-2 hover:text-primary'>New Product <FontAwesomeIcon icon={faPlus}/> </li>
                                <li className='pb-2 hover:text-primary  '>Logout</li>
                            </ul>
                            </li>
