    ...
    return ( 
        <div>
            <div className="max-w-[1200px] my-20 mx-auto grid grid-cols-4 text-center">
                <div className="des:col-span-2 tablet:col-span-4 phone:col-span-4 border-r-2 my-10">
                    <div className=''>
                ...
                <div className="des:col-span-2 tablet:col-span-4 phone:col-span-4 my-10 ">
                    <div className=''>
                ...
                <div className="des:col-span-1 tablet:col-span-4 phone:col-span-4 border-l-2 my-10">
                    <div>
            ...
            <div className='h-[60px] text-center bg-[#f2f2f2] leading-[60px] text-[#999]'>
                <h1>Copyright 2022 Pizzle. All Rights Reserved.</h1>
            </div>
        </div>
     );
}
