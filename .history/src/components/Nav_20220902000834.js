           ...
           <div className='max-w-[1200px] my-0 mx-auto flex items-center h-14 justify-between '>
            <div>
                    <ul className='flex h-14 items-center hover:cursor-pointer relative' >
                        ...
                        <li className='relative'><a href='' className='mr-6 text-white hover:text-yellow-200 nav' >MENU</a>
                            <ul className='absolute bg-white py-6 rounded-[10px] text-[18px] font-semibold left-[-16px] nav-a hidden z-50 '>
