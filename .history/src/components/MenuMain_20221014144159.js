        ...
        <div>
            ...
            <div className='bg-menudetail '>
                <div className='max-w-[1000px] my-0 mx-auto'>
                    <div className='des:p-20 tablet:p-[18px] phone:hidden tablet:block '>
                        <ul className='flex bg-[#ebebeb]  py-4  rounded-[40px] tablet:justify-center des:justify-between hover:cursor-pointer relative'>
