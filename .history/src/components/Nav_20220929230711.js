                ...
                <div className='max-w-[1200px] my-0 mx-auto flex items-center h-14 justify-between '>
                    ...
                    <div>
                        <ul className='flex h-14 items-center hover:cursor-pointer '>
                            ...
                            />
                            <ul className='absolute bg-white top-[44px] text-center w-[140px]  left-[-46px] py-6 rounded-[10px] shadow-xl  font-delius optionUser none '>
                                <li className='pb-2 hover:text-primary hover:bg-yellow-100'>New Product <FontAwesomeIcon icon={faPlus} className='ml-1'/> </li>
                                <li 
