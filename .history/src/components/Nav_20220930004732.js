                        ...
                        <ul className='flex h-14 items-center hover:cursor-pointer  '>
                            ...
                            <li className='relative text-xl text-white ml-24 hover:text-yellow-200 '>
                                <Link to='/cart ' className='iconProduct' >
                                    ...
                                    <FontAwesomeIcon icon={faBasketShopping} className='relative z-50 '>
                                        
                                    </FontAwesomeIcon>
                                    <div className='w-[400px] min-h-[400px] bg-white absolute top-[42px] right-[-160px] listProduct  hidden '>
                                            <ul>
                                ...
                                <div className=''>
                                       <span className='absolute text-[14px] px-2   text-center font-bold text-primary rounded-full border-[1px] top-[-10px] left-[10px] border-[#1e293b] border-solid bg-white' >0</span>
                                </div>
