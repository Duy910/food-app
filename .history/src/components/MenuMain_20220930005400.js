        ...
        <div>
            ...
            <div className='bg-menudetail '>
                <div className='max-w-[1000px] my-0 mx-auto'>
                    <div className='p-20 '>
                        <ul className='flex bg-[#ebebeb]  py-4  rounded-[40px] justify-between hover:cursor-pointer'>
                        <li className=''>
                                <a className=' activeMenu font-bold font-delius text-[16px] rounded-[40px] px-6 py-4 '>ALL</a>
                            </li>
                            <li className=''>
                                <a className=' font-bold font-delius text-[16px] rounded-[40px]  px-6 py-4'>PIZZAS</a>
                            </li>
                            
                            <li className=''>
                                <a className=' font-bold font-delius text-[16px] rounded-[40px] px-6 py-4 '>DRINKS</a>
                            </li>
                            <li className=''>
                                <a className=' font-bold font-delius text-[16px] rounded-[40px] px-6 py-4 '>SALADS</a>
                            </li>
                            <li className=''>
                                <a className=' font-bold font-delius text-[16px] rounded-[40px] px-6 py-4 '>PASTA</a>
                            </li>
                            <li className=''>
                                <a className=' font-bold font-delius text-[16px] rounded-[40px] px-6 py-4 '>BURGER</a>
                            </li>
                            <li className=''>
                                <a className=' font-bold font-delius text-[16px] rounded-[40px] px-6 py-4 '>DESERTS</a>
                            </li>
                ...
                <div className='max-w-[1200px] my-0 mx-auto' >
                    <div className=' flex justify-around mb-20'>
                            <div className=' '>
                                <div className='py-6 hover:shadow-2xl hover:rounded-[10px]' >   
                            ...
                            <div className=' '>
                                <div className='py-6 px-2 hover:shadow-2xl hover:rounded-[10px] ' >   
                                    <div className='flex bg-[#fff8ef] '>
                                        <div className='max-w-[120px] mr-3'>
                                            <img src={pizza1} />
                                        </div>
                                        <div className='relative overflow-hidden menuCart hover: cursor-pointer'>
