    ...
    return ( 
        <div className='h-[800px] bg-slider bg-black bg-cover ' >
            <div className='max-w-[1200px] my-0 mx-auto h-full relative  '>
                <div className=' bg-sliderPizza bg-no-repeat h-[580px] w-[620px] right-0 absolute top-[94px] phone:hidden md:hidden lg:block'>

                </div>
                <div>
                    <h1 id='slider' className="text-white phone:text-[40px]  md:text-[80px] font-black absolute top-[238px]">Enjoy Your Pizza</h1>
                    <span id='slider' className="text-white  md:text-[80px] font-black absolute top-[330px]">In Town</span>
                    {/* <img src={shape1}/> */}
