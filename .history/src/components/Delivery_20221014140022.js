    ...
    return ( 
        <div className="h-[700px] bg-[#fff8ef] relative">
            ...
            <div className='max-w-[1200px] my-0 mx-auto h-full grid grid-cols-2 '>
                <div className='tablet:col-span-1 phone:col-span-2 mr-10 relative'>
                    <img src={biker} className='z-20 absolute top-[18%] left-0'/>
                </div>
                <div className='phone:col-span-2 tablet:col-span-1'>
                    <div className='content'>
                        <div>
                            <h1 className='font-delius text-primary md:text-[30px] phone:text-[20px] mt-20 phone:mt-[60px]'>FREE DELIVERY</h1>
                        </div>
                        <div>
