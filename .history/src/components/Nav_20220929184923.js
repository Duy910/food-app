                ...
                <div className='max-w-[1200px] my-0 mx-auto flex items-center h-14 justify-between '>
                    ...
                    <div>
                        <ul className='flex h-14 items-center hover:cursor-pointer '>
                            ...
                            <li className='relative '><img
                                src={user ? user.photoURL : Avatar}
                                className='w-10 ml-20 rounded-full imageUser'
                                onClick={login}

                            />
                            <ul className='absolute bg-white top-[48px] text-center w-[140px]  left-[34px] py-6 rounded-[10px] shadow-xl  font-delius optionUser hidden'>
