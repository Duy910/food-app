                ...
                <div className='max-w-[1200px] my-0 mx-auto flex items-center h-14 justify-between '>
                    ...
                    <div>
                        <ul className='flex h-14 items-center hover:cursor-pointer '>
                            ...
                            />
                            <ul className='absolute bg-white top-[48px] text-center left-[65px] py-6 rounded-[10px]  '>
                                <li className='pb-2 absolute px-10'>New Product </li>
                                <li className='pb-2 absolute'>Logout</li>
                            </ul>
                            </li>
