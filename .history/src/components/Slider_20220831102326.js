    ...
    return ( 
        <div className='h-[800px] bg-slider bg-black bg-cover ' >
            <div className='max-w-[1200px] my-0 mx-auto h-full relative  '>
                ...
                <div>
                    <span id='slider' className="text-white  text-[80px] font-black ">Enjoy Your Pizza</span>
                    <br><span id='slider' className="text-white  text-[80px] font-black">In Town</span></br>
                </div>
