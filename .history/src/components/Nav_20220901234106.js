            ...
            <div>
                    <ul className='flex h-14 items-center hover:cursor-pointer relative' >
                        ...
                        <li className='relative'><a href='' className='mr-6 text-white hover:text-yellow-200' >MENU</a>
                            <ul className='absolute bg-white py-6 rounded-[10px] text-[20px]'>
                                <li className=''><a className='pl-4 block pr-20 '>Home</a></li>
                                <li className=''><a className='pl-4 block '>Sign in</a></li>
                                <li className=''><a className='pl-4 block'>Sign up</a></li>
                                <li className=''><a className='pl-4 block'>Cart</a></li>
                            </ul>
                        </li>
