            ...
            <div className='bg-menudetail '>
                ...
                <div className='max-w-[1200px] my-0 mx-auto' >
                    <div className=' flex  mb-20'>
                        <div className=' '>
                            <div className='py-6 hover:shadow-2xl hover:rounded-[10px] hover:bg-[#fff8ef] w-[600px] gap-10' >
                        ...
                        <div className=' '>
                            <div className='py-6 hover:shadow-2xl hover:rounded-[10px] hover:bg-[#fff8ef] w-[600px] ' >
                                <div className='flex px-2'>
                                    <div className='max-w-[120px] mr-3'>
                                        <img src={pizza1} />
                                    </div>
