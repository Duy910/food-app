                        ...
                        <ul className='flex h-14 items-center hover:cursor-pointer  '>
                            ...
                            />
                                <ul className='absolute bg-[#fff8ef] top-[44px]  w-[140px]  left-[-46px] py-6 rounded-[10px] shadow-xl  font-delius optionUser none  '>
                                    <li className='py-2 hover:text-primary border-[4px] bg-[#ccc] px-2  '>New Product <FontAwesomeIcon icon={faPlus} className='ml-1' /> </li>
                                    <li
                                        className='py-2 hover:text-primary border-[2px] px-2 ' onClick={logout}>Logout <FontAwesomeIcon icon={faRightFromBracket} className='ml-1'
