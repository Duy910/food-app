    ...
    return ( 
        <div>
            <div className="max-w-[1200px] my-20 mx-auto grid grid-cols-4 text-center">
                <div className="lg:col-span-1 md:col-span-4 border-r-2 my-10">
                    <div className=''>
                ...
                <div className="lg:col-span-1 md:col-span-4 my-10 ">
                    <div className=''>
                ...
                <div className="lg:col-span-1 md:col-span-4 border-l-2 my-10">
                    <div>
