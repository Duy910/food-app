        ...
        <div className=" h-[500px] ">
            <div className="max-w-[1200px] h-full my-0 mx-auto grid grid-cols-2 ">
                <div className="bg-red-300 col-span-1 h-[250px] mr-5 mt-[25%] promo1 bg-cover bg-center bg-no-repeat rounded-[20px] relative">
                    ...
                    <div className=''>
                    <a href='' className=' top-[57%] px-[15px] py-[15px] rounded-[30px]  bg-orange-300 absolute text-[20px] text-white'> <FontAwesomeIcon className='mr-[10px]' icon={faShoppingCart}/>Order Now</a>
                </div>
                </div>
