    ...
    return (
        <div>
            ...
            <div className='bg-menudetail '>
                ...
                <div className='max-w-[1200px] my-0 mx-auto grid grid-cols-2 gap-3' >
                    <div className='  mb-20'>
                        <div className=' '>
                            {foodItems.map((foodItem, index) => {
                                return (
                                    <div className='py-6 hover:shadow-2xl hover:rounded-[10px] hover:bg-[#fff8ef] col-span-1' >
                                        <div className='flex px-2'>
                                            <div className='max-w-[120px] max-h-[120px] mr-3 bg-cover'>
