                ...
                <div className='max-w-[1200px] my-0 mx-auto flex items-center h-14 justify-between '>
                    ...
                    <div>
                        <ul className='flex h-14 items-center hover:cursor-pointer '>
                            ...
                            <li className='text-2xl ml-6 text-white hover:text-yellow-200 ' ><Link to='/food-app'><FontAwesomeIcon icon={faYoutube} className='ml-10' /></Link></li>
                            ...
                            />
                            <ul className='absolute bg-white top-[48px] text-center w-[140px]  left-[-46px] py-6 rounded-[10px] shadow-xl  font-delius optionUser none'>
                                <li className='pb-2 hover:text-primary'>New Product <FontAwesomeIcon icon={faPlus} className='ml-1'/> </li>
                                <li 
                                    className='pb-2 hover:text-primary  ' onClick={logout}>Logout <FontAwesomeIcon icon={faRightFromBracket} className='ml-1'
