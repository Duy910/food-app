            ...
            <div>
                    <ul className='flex h-14 items-center hover:cursor-pointer relative' >
                        ...
                        <li className='relative nav'><a href='' className='mr-6 text-white hover:text-yellow-200 ' >MENU</a>
                            <ul className='absolute bg-white py-6 rounded-[10px] text-[18px] font-semibold left-[-16px] navUl hidden  '>
                                <li className=''><a className='pl-4 block pr-20 py-1 hover:text-primary'>Home</a></li>
                                <li className=''><a className='pl-4 block py-1 hover:text-primary'>Sign in</a></li>
                                <li className=''><a className='pl-4 block py-1 hover:text-primary'>Sign up</a></li>
                                <li className=''><a className='pl-4 block py-1 hover:text-primary'>Cart</a></li>
                            </ul>
                        </li>
