                ...
                <div className='grid grid-cols-4'>
                    <div className=' col-span-1 '>
                        <div className='text-center font-semibold p-10 border-2 rounded-[10px] hover:cursor-pointer hover:bg-[#fffbf1] hover:shadow-2xl mb-20 relative menu'>
                            ...
                            <a className='menu-a absolute '>
                                <button className='bg-primary py-3 px-5 rounded-[10px] text-[20px] text-white menu-a absolute'>Add to cart</button>
                            </a>
                            <div className=''>
                                <h1 className='font-dirt text-[40px] text-primary mt-10'>Pizza</h1>
                            </div>
                            <div>
