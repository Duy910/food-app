            ...
            <div className='max-w-[1200px] my-0 mx-auto h-full grid grid-cols-2 '>
                ...
                <div className='col-span-1'>
                    <div className='content'>
                        <h1 className='md:text-[50px] phone:text-[60px]'>THE BEST</h1>
                        <h1 className='md:text-[120px] font-extrabold text-[#fdba74] phone:ml-[-28px] md:ml-[-20px] phone:text-[60px]'>PIZZA</h1>
                        <h1 className='md:text-[50px] phone:text-[30px]  phone:ml-[20px] md:ml-20'>AROUND</h1>
