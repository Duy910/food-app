                ...
                <div className='max-w-[1200px] my-0 mx-auto flex items-center h-14 justify-between '>
                    ...
                    <div>
                        <ul className='flex h-14 items-center hover:cursor-pointer hover:text-yellow-200'>
                            ...
                            <li className='text-white ml-10 hover:text-yellow-200 hide'><Link to='/signin'>Sign in</Link></li>
                            <li className='text-white ml-8 hover:text-yellow-200 hide'><Link to='/signup'>Sign up</Link></li>
