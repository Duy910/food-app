                            ...
                            <li className='relative text-xl text-white ml-24 hover:text-yellow-200 '>
                                <Link to='/cart ' className='iconProduct' >
                                    ...
                                    <div className='w-[400px]  z-20  absolute top-[42px] right-[-160px] listProduct   bg-white '>
                                        ...
                                        <ul className='h-[400px] overflow-y-scroll listProductUl '>
                                            <li className='my-2 flex bg-[#fff8ef] justify-around relative '>
                                        ...
                                        <div className=' bg-[#fff8ef]  h-[100px] mt-[24%] rounded-t-[20px] flex items-center justify-around'>
                                            <div className='flex font-delius italic font-bold items-center '>
                                                <h1 className='text-primary  text-[18px] '>Sub-total:
                                                </h1>
                                                <h1 className='text-black text-[18px]'> <FontAwesomeIcon icon={faEuroSign} />23.3</h1>
                                            </div>
                                            <div>
                                                <button className='text-black font-bold items-center bg-primary p-2 rounded-[10px]'>Check Out</button>
                                            </div>
                                        </div>
                                ...
                                <div className=''>
                                    <span className='absolute text-[14px] leading-4 italic px-2 text-center font-bold text-primary rounded-full border-[1px] top-[-6px] left-[10px] border-[#1e293b] border-solid bg-white' >0</span>
                                </div>
