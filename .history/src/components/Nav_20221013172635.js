    ...
    return (
        ...
        <nav>
            <div className=" h-14 bg-slate-800 fixed w-full z-50 font-delius">
                ...
                <div className='max-w-[1200px] my-0 mx-auto xl:flex items-center h-14 justify-between hidden'>
                    <div className=''>
                ...
                <div className='max-w-[1200px] my-0 mx-auto md:flex justify-between hidden xl:hidden'>
                    ...
                    <li className='relative imageUser    '><img
                        ...
                        <li className='relative text-xl text-white ml-24 hover:text-yellow-200 mr-[20px]'>
                            <div href='/food-app' className='iconProduct' >
