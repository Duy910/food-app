    ...
    return ( 
        <div className='h-[800px] bg-slider bg-black bg-cover ' >
            <div className='max-w-[1200px] my-0 mx-auto h-full relative  '>
                <div className=' bg-sliderPizza bg-no-repeat lg:h-[580px] lg:w-[620px] right-0 absolute top-[94px] phone:hidden md:h-[100px] md:block lg:block'>
                ...
                <div>
                    ...
                    <img className='md:absolute phone:hidden  right-[40%] top-[46%]' src={shape3}/>
