            ...
            <div className='bg-menudetail '>
                <div className='max-w-[1000px] my-0 mx-auto'>
                    <div className='p-20 '>
                        ...
                        <li className=''>
                                <a className=' activeMenu font-bold font-delius text-[10px] rounded-[40px] px-6 py-4 '>ALL</a>
                            </li>
                            <li className=''>
                                <a className=' font-bold font-delius text-[10px] rounded-[40px]  px-6 py-4'>PIZZAS</a>
                            </li>
                            <li className=''>
                                <a className=' font-bold font-delius text-[10px] rounded-[40px] px-6 py-4 '>DRINKS</a>
                            </li>
                            <li className=''>
                                <a className=' font-bold font-delius text-[10px] rounded-[40px] px-6 py-4 '>SALADS</a>
                            </li>
                            <li className=''>
                                <a className=' font-bold font-delius text-[10px] rounded-[40px] px-6 py-4 '>PASTA</a>
                            </li>
                            <li className=''>
                                <a className=' font-bold font-delius text-[10px] rounded-[40px] px-6 py-4 '>BURGER</a>
                            </li>
                            <li className=''>
                                <a className=' font-bold font-delius text-[10px] rounded-[40px] px-6 py-4 '>DESERTS</a>
                            </li>
