                ...
                <div className='max-w-[1200px] my-0 mx-auto flex items-center h-14 justify-between '>
                    ...
                    <div>
                        <ul className='flex h-14 items-center hover:cursor-pointer '>
                            ...
                            <li className='text-xl text-white ml-24 hover:text-yellow-200'><Link to='/cart'><FontAwesomeIcon icon={faBasketShopping} /></Link>
                                <div className='w-[400px] max-h-[50vh] bg-white absolute'>
