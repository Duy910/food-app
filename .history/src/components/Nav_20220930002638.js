                    ...
                    <div>
                        <ul className='flex h-14 items-center hover:cursor-pointer  '>
                            ...
                            <li className='relative text-xl text-white ml-24 hover:text-yellow-200 '>
                                ...
                                <div className='absolute  py-2 px-3 bg-white text-primary rounded-full border-[2px] top-[-3px] left-[10px] border-[#1e293b] border-solid'>
                                        <span className='text-[2px]'>1</span>
                                </div>
