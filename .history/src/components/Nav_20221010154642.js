                            ...
                            <li className='relative text-xl text-white ml-24 hover:text-yellow-200 '>
                                <Link to='/cart ' className='iconProduct' >
                                    ...
                                    <div className='w-[400px]  z-20  absolute top-[42px] right-[-160px] listProduct   bg-white '>
                                        ...
                                        <div className=' bg-primary  h-[100px] mt-[24%] rounded-t-[20px] '>
                                            <div className='flex text-black text-[18px]'>
                                                <h1 className='text-white font-bold font-delius italic text-[18px] my-2'>Sub-total:
                                                </h1>
                                                <h1 className=''> <FontAwesomeIcon icon={faEuroSign} />23.3</h1>
                                            </div>
                                        </div>
