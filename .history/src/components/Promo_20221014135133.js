    ...
    return ( 
        <div className=" h-[500px] relative">
            ...
            <div className="max-w-[1200px] h-full my-0 mx-auto grid grid-cols-2 ">
                ...
                <div className=" tablet:col-span-1 phone:col-span-2 h-[50%] tablet:mr-5 mt-[125px]  promo1 bg-cover bg-center bg-no-repeat rounded-[20px] relative hover:shadow-2xl">
                ...
                <div className=" tablet:block phone:hidden col-span-1 h-[50%] ml-5 mt-[125px] promo2 bg-cover bg-center bg-no-repeat  rounded-[20px] relative hover:shadow-2xl">
