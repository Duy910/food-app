                        ...
                        <ul className='flex h-14 items-center hover:cursor-pointer  '>
                            ...
                            <li className='relative text-xl text-white ml-24 hover:text-yellow-200 '>
                                <Link to='/cart ' className='' >
                                    ...
                                    <FontAwesomeIcon icon={faBasketShopping} className='relative iconProduct'>
                                        
                                    </FontAwesomeIcon>
                                    <div className='w-[400px] min-h-[400px] bg-white absolute top-[42px] right-[-160px] listProduct rounded-[10px] hidden '>
                                            <ul>
