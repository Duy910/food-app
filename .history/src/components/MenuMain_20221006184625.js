            ...
            <div className='max-w-[1000px] my-0 mx-auto'>
                <div className='p-20 '>
                    <ul className='flex bg-[#ebebeb]  py-4  rounded-[40px] justify-between hover:cursor-pointer'>
                        <li className=''>
                            <a onClick={handleActive} className=' activeMenu font-bold font-delius text-[16px] rounded-[40px] px-6 py-4 tab '>ALL</a>
                        </li>
                        <li className=''>
                            <a onClick={handleActive} className=' font-bold font-delius text-[16px] rounded-[40px]  px-6 py-4 tab'>PIZZAS</a>
                        </li>

                        <li className=''>
                            <a className=' font-bold font-delius text-[16px] rounded-[40px] px-6 py-4 tab'>DRINKS</a>
                        </li>
                        <li className=''>
                            <a className=' font-bold font-delius text-[16px] rounded-[40px] px-6 py-4 tab'>SALADS</a>
                        </li>
                        <li className=''>
                            <a className=' font-bold font-delius text-[16px] rounded-[40px] px-6 py-4 tab'>PASTA</a>
                        </li>
                        <li className=''>
                            <a className=' font-bold font-delius text-[16px] rounded-[40px] px-6 py-4 tab'>BURGER</a>
                        </li>
                        <li className=''>
                            <a className=' font-bold font-delius text-[16px] rounded-[40px] px-6 py-4 tab'>DESERTS</a>
                        </li>
