...
function Nav() {
    return ( 
        <div className="flex items-center h-14 bg-slate-800 justify-between">
            ...
            <div>
                <ul className='flex h-14 items-center '>
                    <li className='text-3xl bg-white'><FontAwesomeIcon icon={faFacebook}/></li>
                    <li className='text-3xl'><FontAwesomeIcon icon={faInstagram}/></li>
                    <li className='text-3xl'><FontAwesomeIcon icon={faYoutube}/></li>
                    <li className='text-3xl'><FontAwesomeIcon icon={faTwitter}/></li>
                    <li >LOGIN</li>
                    <li className='text-3xl'><FontAwesomeIcon icon={faBagShopping}/></li>
