        ...
        <div className=" h-14 bg-slate-800 ">
           ...
           <div className='max-w-screen-xl flex items-center h-14 justify-between my-0 mx-auto'>
            <div>
                ...
                <div>
                    <ul className='flex h-14 items-center '>
                        <li className='text-2xl ml-10 text-white'><FontAwesomeIcon icon={faFacebook}/></li>
                        <li className='text-2xl text-white'><FontAwesomeIcon icon={faInstagram}/></li>
                        <li className='text-2xl text-white'><FontAwesomeIcon icon={faYoutube}/></li>
                        <li className='text-2xl text-white'><FontAwesomeIcon icon={faTwitter}/></li>
