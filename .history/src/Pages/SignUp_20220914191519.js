...
function SignUp() {
   ...
   const validator = (values) => {
        ...
        if(!values.username) {
            ...
            var invalid = document.querySelector('.formGroup')
            invalid.classList.add('invalid')
        }
        if(!values.email) {
            errorList.username = 'Email is empty'
            var invalid = document.querySelector('.formGroup')
            invalid.classList.add('invalid')
        }
        if(!values.password) {
            errorList.username = 'Passaword is empty'
            var invalid = document.querySelector('.formGroup')
            invalid.classList.add('invalid')
        }
                    ...
                    <div className=" ">
                        ...
                        <form className='formSignup'   onSubmit={handleSubmit} >
                            <div className="formGroup">
                                ...
                                <span className='formMess'>{formerrors.username}</span>
                            </div>
                            <div className='formGroup '>
                                <input id='email'
                                 name='email'
