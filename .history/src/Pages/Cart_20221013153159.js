                                    ...
                                    {cartItems && cartItems.length > 0 ? (<table className="w-[100%] ">
                                        <thead className=" ">
                                            <tr className=" relative text-center  ">
                                                ...
                                                <th className="">
                                                <h1  className="mr-[100%]">Price</h1>
                                                </th>
                                                <th className="">
                                                <h1  className="mr-[100%]">Quantity</h1>
                                                </th>
                                                <th className="">
                                                <h1  className="mr-[100%]">Total</h1>
                                                </th>
                                        ...
                                        {cartItems?.map(cartitem => (<tbody key={cartitem.id} className="">
                                            <tr  className="border-t-[1px] border-[#ccc]   ">
                                                <td className="w-[20%] mx-auto">
                                                    <img className="w-[100%] h-[120px] bg-[#fef0de] rounded-[4px]  " src={cartitem.imgURL} />
                                                </td>
