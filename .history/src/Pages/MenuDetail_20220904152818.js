        ...
        <div>
            ...
            <div className='bg-menudetail '>
                <div className='max-w-[1200px] my-0 mx-auto'>
                    <div className='p-20 '>
                        <ul className='flex bg-[#ebebeb]  py-4 rounded-[40px] justify-around pl-0 pr-0'>
                        <li className=''>
                                <a className='font-bold font-delius text-[20px] rounded-[40px] px-6 py-4 '>ALL</a>
                            </li>
                            <li className=''>
                            ...
                            <li className=''>
                                <a className=' activeMenu  font-bold font-delius text-[20px] rounded-[40px] px-6 py-4 '>DESERTS</a>
                            </li>
