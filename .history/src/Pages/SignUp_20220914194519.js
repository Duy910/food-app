                    ...
                    <div className=" ">
                        ...
                        <form className='formSignup' >
                            ...
                            <div className='formformGroupignup'>
                                ...
                                onChange={handleChange}
                                onBlur={handleBlur}
                                className=" formInput w-[100%]  p-[8px] text-[16px] my-2 border-primary border-[2px] rounded-[4px] bg-[#fff8ef] outline-none" type='checkbox' placeholder="Confirm your passwords..." />
