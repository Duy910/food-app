                ...
                <div className="   ">
                    <div className=" ">
                        ...
                        <form className='formSignup'>
                            <div className="formGroup invalid ">
                                <input className=" formInput w-[100%]  p-[8px] text-[16px] my-2 border-primary border-[2px] rounded-[4px] bg-[#fff8ef] outline-none" type='text' placeholder="User name..." />
                                <span className='formMess'>Vui long nhap truog nay</span>
                            </div>
                            <div className='formGroup invalid'>
                                <input className=" formInput w-[100%]  p-[8px] text-[16px] my-2 border-primary border-[2px] rounded-[4px] bg-[#fff8ef] outline-none" type='text' placeholder="Your email..." />
                                <span className='formMess'>Vui long nhap truong nay !</span>
                            </div>
                            <div className='formGroup'>
                                <input className=" formInput w-[100%]  p-[8px] text-[16px] my-2 border-primary border-[2px] rounded-[4px] bg-[#fff8ef] outline-none" type='text' placeholder="Passwords..." />
                                <span className='formMess'></span>
                            </div>
                            <div className='formformGroupignup'>
                                <input className=" formInput w-[100%]  p-[8px] text-[16px] my-2 border-primary border-[2px] rounded-[4px] bg-[#fff8ef] outline-none" type='text' placeholder="Confirm your passwords..." />
                                <span className='formMess'></span>
                            </div>
