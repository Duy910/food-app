...
function Cart() {
    ...
    const handleTotal = (product) => {
        setSubTotal(product.qty * product.price)
                                ...
                                <div className="p-4 bg-[#fff8ef] rounded-[20px]">
                                    {cartItems && cartItems.length > 0 ? (<table className=" ">
                                        ...
                                        {cartItems?.map(cartitem => (<tbody className="">
                                            <tr key={cartiem.id} className="border-t-[1px] border-[#ccc] relative">
                                                <td className="">
                                                ...
                                                <td className="">
                                                    <div className="flex justify-left align-center text-[18px]">
                                                        ...
                                                        <p className="">{ ()=>handleTotal(cartitem)}
                                                        </p>
                                    ...
                                    <table className="w-[100%]">
                                        <tbody className="text-[18px] font-delius font-semibold italic">
                                            <tr className=" w-[100%]">
                                                ...
                                                <td className=""><FontAwesomeIcon icon={faEuroSign} />${subtotal}</td>
                                            </tr>
