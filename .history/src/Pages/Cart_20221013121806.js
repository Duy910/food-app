                                    ...
                                    <table className="w-[100%]">
                                        <tbody className="text-[18px] font-delius font-semibold italic">
                                            ...
                                            <tr className="border-t-[1px] border-[#ccc]">
                                                ...
                                                { cartItems && cartItems === '' ? (<td><FontAwesomeIcon icon={faEuroSign} />5.2</td>) : (<td><FontAwesomeIcon icon={faEuroSign} />0</td>) }
                                            </tr>
                                            <tr className="border-t-[1px] border-[#ccc]">
                                                <td>Order Total</td>
                                                {cartItems && cartItems === '' ? (<td><FontAwesomeIcon icon={faEuroSign} />{total + 5.2}</td>) : (<td><FontAwesomeIcon icon={faEuroSign} />{total + 5.2}</td>)}
                                            </tr>
                                        </tbody>
                                    </table>
                                </div>
