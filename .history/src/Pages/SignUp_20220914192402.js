                    ...
                    <div className=" ">
                        ...
                        <form className='formSignup'   onSubmit={handleSubmit} >
                            <div className="formGroup">
                                ...
                                <span className='formMess text-red-500'>{formerrors.username}</span>
                            </div>
                            <div className='formGroup '>
                                <input id='email'
                                 name='email'
                                ...
                                <span className='formMess text-red-500' >{formerrors.email}</span>
                            </div>
                            <div className='formGroup'>
                                <input id='passWord' 
                                name='password'
                                ...
                                onChange={handleChange}
                                 className=" formInput w-[100%]  p-[8px] text-[16px] my-2 border-primary border-[2px] rounded-[4px] bg-[#fff8ef] outline-none" type='passwprd' placeholder="Passwords..." />
                                <span className='formMess text-red-500'>{formerrors.password}</span>
                            </div>
                            <div className='formformGroupignup'>
                                ...
                                onChange={handleChange}
                                className=" formInput w-[100%]  p-[8px] text-[16px] my-2 border-primary border-[2px] rounded-[4px] bg-[#fff8ef] outline-none" type='text' placeholder="Confirm your passwords..." />
