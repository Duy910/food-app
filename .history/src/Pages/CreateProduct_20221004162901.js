                            ...
                            {fields && (
                                <div className='grid grid-cols-2 gap-1'>
                                    <div className='col-span-1'>
                                        <p className='w-[100%]  p-[8px] text-[16px] my-2 border-primary border-none rounded-[4px] bg-green-400 text-white outline-none font-delius italic '>
                                            ipload imag successfully!</p>
                                    </div>
