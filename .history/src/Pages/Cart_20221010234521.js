                    ...
                    <div className="grid grid-cols-3 gap-10 ">
                            ...
                            <div className=" ">
                                ...
                                <div className="p-4 bg-[#fff8ef] rounded-[20px]">
                                    <table className=" ">
                                      ...
                                      { cartItems && cartItems.length > 0 ? (  <tbody className="">
                                        ...
                                        </tbody>): (<div className="flex justify-center">
                        ...
                        <div className="col-span-1">
                            <div className="">
                                    ...
                                    <table className="w-[100%]">
                                        <tbody className="text-[18px] font-delius font-semibold italic">
                                            <tr className=" w-[100%]">
                                                ...
                                                <td className=""><FontAwesomeIcon icon={faEuroSign}/>123</td>
                                            </tr>
                                ...
                                <div>
                                    <button className="float-right py-2 px-4 bg-primary rounded-[20px] font-semibold font-delius text-[18px] hover:cursor-pointer mt-10 hover:shadow-2xl hover:text-white">
                                        Order Now</button>
                                </div>
                            </div>
