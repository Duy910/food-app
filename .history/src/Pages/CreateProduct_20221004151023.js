...
import '../css/createproducts.csss'
                ...
                <div className=" max-w-[600px] my-0 mx-auto  ">
                    <div className=" ">
                        ...
                        <div>
                            ...
                            <div>
                                <button className='w-[100%]  p-[8px] text-[18px] hover:text-black  my-2 border-none border-[2px] rounded-[4px]  outline-none bg-green-400 text-white font-delius saveProduct '>Save</button>
                            </div>
