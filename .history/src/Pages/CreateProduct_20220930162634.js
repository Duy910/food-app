            ...
            <div className=" max-w-[600px] my-0 mx-auto  ">
                <div className=" ">
                    ...
                    <div>
                        ...
                        <div className='w-[100%]  p-[8px] text-[16px] my-2 border-primary border-[2px] rounded-[4px] bg-[#fff8ef] h-[200px]'>
                            {isLoading ? <Loader className='flex justify-center'/> : <div></div>}
                        </div>
