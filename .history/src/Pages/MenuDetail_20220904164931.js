                                ...
                                <div className='py-6' >   
                                    <div className='flex '>
                                        ...
                                        <div className='relative overflow-hidden menuCart hover: cursor-pointer'>
                                            ...
                                            <div  >
                                                <button className='px-4 py-2 bg-primary rounded-[8px] font-semibold  hover:text-white cartButton hidden absolute  hover:cursor-pointer shadow-slate-500'>Add to cart
                                                </button>
                                            </div>
                                        </div>
                                    </div>
