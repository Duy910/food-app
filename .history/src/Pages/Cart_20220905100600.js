                    ...
                    <div className="grid grid-cols-3 gap-10 ">
                        ...
                        <div className="col-span-1">
                            <div className="">
                                ...
                                <div>
                                    <button className="float-right py-2 px-4 bg-primary rounded-[20px] font-semibold font-delius text-[18px] hover:cursor-pointer mt-10 shadow-lg">Order Now</button>
                                </div>
                            </div>
