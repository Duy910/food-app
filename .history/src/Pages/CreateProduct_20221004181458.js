                ...
                <div className=" max-w-[600px] my-0 mx-auto  ">
                    <div className=" ">
                        ...
                        <div>
                                ...
                                {isLoading ? (<Loader className='mr-0' />) : (<>
                                    {!imgValue ?
                                        ...
                                        <div>
                                            ...
                                            <button
                                                className='border-primary bg-primary rounded-[8px] p-[8px] font-delius text-white hover:text-black ml-20'
                            ...
                            <div>
                                <button className='w-[100%]  p-[8px] text-[18px]   my-2 border-none border-[2px] rounded-[4px] z-10 bg-green-400 text-white font-delius saveProduct '
                                    onClick={saveProduct}
                                >Save</button>
                            </div>
