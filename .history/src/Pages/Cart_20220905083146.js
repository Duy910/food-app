                            ...
                            <div className=" ">
                                <div className="p-4 bg-[#fff8ef] rounded-[10px]">
                                    <table className=" ">
                                        ...
                                        <tbody className="">
                                            <tr className="border-t-2 border-primary relative">
                                                <td className="pr-2 pt-2">
                                                    <img className="max-w-[120px] bg-[#fef0de] rounded-[4px]" src={pizza1} />
                                                </td>
                                                <td className="font-semibold font-delius">
                                                    Paneek Makhani Pizza
                                                </td>
                                                <td className="left-0 ">
                                                    <div className="flex justify-left align-center text-[18px] text-primary">
