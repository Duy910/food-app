        ...
        <div className="bg-[#fff8ef] min-h-screen    ">
            ...
            <div className=" max-w-[800px] my-0 mx-auto  ">
                <div className=" ">
                    ...
                    <div>
                        <div className="">
                            <input className="w-[100%]  p-[8px] text-[16px] my-2 border-primary border-[2px] rounded-[4px] bg-[#fff8ef] outline-none" type='text' placeholder="Give me your title you want..."/>
                        </div>
